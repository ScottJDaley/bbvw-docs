...
![kingdra](../img/pokemon/230.png){ width=150 }

## Type
![water](../img/types/water.png){ width=60 } ![dragon](../img/types/dragon.png){ width=60 }
...
| 0x | 0.5x | 2x | 4x |
| --- | --- | --- | --- |
|  | ![fire](../img/types/fire.png){ width=40 } | ![dragon](../img/types/dragon.png){ width=40 } |  |
...
| Route | Method | Rate |
| --- | --- | --- |
| [Dragonspiral Tower Outside (Both Areas) – Spring, Summer, Autumn](../routes/dragonspiral-tower-outside-(both-areas)---spring,-summer,-autumn.md) | ![fish, special](../img/items/grass-special.png){ width=20 } Fish, Special | 9% |
| [Dragonspiral Tower Outside (Both Areas) – Spring, Summer, Autumn](../routes/dragonspiral-tower-outside-(both-areas)---spring,-summer,-autumn.md) | ![fish, special](../img/items/grass-special.png){ width=20 } Fish, Special | 9% |
| [Route 13](../routes/route-13.md) | ![surf, special](../img/items/grass-special.png){ width=20 } Surf, Special | 10% |
