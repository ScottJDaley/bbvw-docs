...
![ludicolo](../img/pokemon/272.png){ width=150 }

## Type
![water](../img/types/water.png){ width=60 } ![grass](../img/types/grass.png){ width=60 }

## Evolution
![lotad](../img/pokemon/270.png){ width=40 } **[Lotad](../pokemon/lotad.md)** ➡️ Lv. 14 ➡️ ![lombre](../img/pokemon/271.png){ width=40 } **[Lombre](../pokemon/lombre.md)** ➡️ Use water-stone ➡️ ![ludicolo](../img/pokemon/272.png){ width=40 } **[Ludicolo](../pokemon/ludicolo.md)**
...
| 0x | 0.5x | 2x | 4x |
| --- | --- | --- | --- |
|  | ![water](../img/types/water.png){ width=40 } | ![poison](../img/types/poison.png){ width=40 } |  |
|  | ![ground](../img/types/ground.png){ width=40 } | ![flying](../img/types/flying.png){ width=40 } |  |
|  | ![steel](../img/types/steel.png){ width=40 } | ![bug](../img/types/bug.png){ width=40 } |  |
...
| 1 | ![normal](../img/types/normal.png){ width=40 } | [Nature power](../moves/nature-power.md) | ![status](../img/types/status.png){ width=30 style="vertical-align:middle; object-fit:contain;" } | - | - | 20 |  |
